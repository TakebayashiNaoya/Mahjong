...
namespace Mahjong.Model.Tiles
{
    ...
    public class TileDeck
    {
        ...
        /// <summary>
        /// シャッフルに使用する乱数生成器
        /// テスト時に決定的な山生成ができるよう外部から注入可能にしている
        /// </summary>
        ...
        /// <param name="random">シャッフルに使用する乱数生成器（未指定時は新規生成）</param>
        public TileDeck(bool isThreePlayer, bool useRedDora = true, Random random = null)
        {
        ...
        /// 山から1枚ツモる
        /// </summary>
        /// <exception cref="InvalidOperationException">山牌が尽きている場合</exception>
        public Tile Draw()
        {
            if (IsEmpty)
            {
                throw new InvalidOperationException("山牌が尽きています");
            }
